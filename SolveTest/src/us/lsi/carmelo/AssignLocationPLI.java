...
public class AssignLocationPLI {
	...
	public static void leeFichero(String file) {
		...
		try {
			AssignLocationPLI.N = lineas.indexOf("#locations") - lineas.indexOf("#components") - 1;
			AssignLocationPLI.L = lineas.indexOf("#transportation_techniques") - lineas.indexOf("#locations") - 1;
			AssignLocationPLI.T = lineas.indexOf("#precedes") - lineas.indexOf("#transportation_techniques") - 1;
			
			AssignLocationPLI.precedes = new Boolean[N][N];
			for (int i = 0; i < N; i++) {
			    for (int j = 0; j < N; j++) {
			        precedes[i][j] = false;
			    }
			...
			AssignLocationPLI.alpha = new Boolean[N][L];
			for (int i = 0; i < N; i++) {
			    for (int j = 0; j < L; j++) {
			        alpha[i][j] = false;
			    }
			...
			AssignLocationPLI.gamma = new Boolean[N][T];
			for (int i = 0; i < N; i++) {
			    for (int j = 0; j < T; j++) {
			        gamma[i][j] = false;
			    }
			...
			AssignLocationPLI.rho = new Boolean[T][L][L];
			for (int t = 0; t < T; t++) {
			    for (int l = 0; l < L; l++) {
				    for (int m = 0; m < L; m++) {
				    	rho[t][l][m] = false;
			...
			AssignLocationPLI.TCOST = new Integer[N][T];
			for (int i = 0; i < N; i++) {
			    for (int t = 0; t < T; t++) {
			    	TCOST[i][t] = 0;
			    }
			...
			AssignLocationPLI.TCO2 = new Integer[N][T];
			for (int i = 0; i < N; i++) {
			    for (int t = 0; t < T; t++) {
			    	TCO2[i][t] = 0;
			    }
			...
			AssignLocationPLI.TTIME = new Integer[N][T];
			for (int i = 0; i < N; i++) {
			    for (int t = 0; t < T; t++) {
			    	TTIME[i][t] = 0;
			    }
			...
			AssignLocationPLI.LCOST = new Integer[N][L];
			for (int i = 0; i < N; i++) {
			    for (int t = 0; t < L; t++) {
			    	LCOST[i][t] = 0;
			    }
			...
			AssignLocationPLI.LCO2 = new Integer[N][L];
			for (int i = 0; i < N; i++) {
			    for (int t = 0; t < L; t++) {
			    	LCO2[i][t] = 0;
			    }
			...
			AssignLocationPLI.LTIME = new Integer[N][L];
			for (int i = 0; i < N; i++) {
			    for (int t = 0; t < L; t++) {
			    	LTIME[i][t] = 0;
			    }
